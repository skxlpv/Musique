...
export const Header = () => {
    ...
    return (
        <div className="mb-16">
            <div className="bg-black/85 border-b border-b-neutral-800
            shadow-white/[3%] flex w-full items-center justify-between
            shadow-medium bg-background px-4 md:px-8 lg:px-60 h-16 fixed top-0 z-10
            backdrop-blur-lg">
